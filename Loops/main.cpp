...
void main()
{
	...
	do
	{
		key = _getch(); //функция _getch() ожидает нажатие клавиши и возвращает ASCII - код  нажатой клавиши. также она объявлена в библиотеке conio.h
		cout << (int)key << "\t" << key << endl; //int(key) - явное преобразование переменной key в тип данных int,для того, чтобы увидеть ASCII - код нажатой клавиши.
	} while (key != Escape);
